    ...
    <div class="inner">
      ...
      <nav>
        <ul class="sf-menu">
          ...
          <li class="current"><a href="vegetable.php">Vegetables</a></li>
                ...
                <div class="grid_7 alpha">
                  <div class="wrapper"> <img src="images/page2-img1.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      ...
                      <button type="button" class="btn btn-success" onclick="on()" id="Carrot 80 1">Buy Now</button>
                    </dl>
                  </div>
                </div>
                <div class="grid_7">
                  <div class="wrapper"> <img src="images/page2-img2.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      ...
                      <button type="button" class="btn btn-success" onclick="on()" id="ind 35 2">Buy Now</button>
                    </dl>
                  </div>
                </div>
                <div class="grid_7 omega">
                  <div class="wrapper"> <img src="images/page2-img8.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      ...
                      <button type="button" class="btn btn-success" onclick="on()" id="cabbage 100 3">Buy Now</button>
                    </dl>
                  </div>
                </div>
              </div>
                ...
                <div class="grid_7 alpha">
                  <div class="wrapper"> <img src="images/page2-img4.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      ...
                      <button type="button" class="btn btn-success" onclick="on()" id="cucumbers 50 4">Buy Now</button>
                ...
                <div class="grid_7">
                  <div class="wrapper"> <img src="images/page2-img5.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      ...
                      <button type="button" class="btn btn-success" onclick="on()" id="corn 65 5">Buy Now</button>
                    </dl>
                  </div>
                </div>
                <div class="grid_7 omega">
                  <div class="wrapper"> <img src="images/page2-img6.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      ...
                      <button type="button" class="btn btn-success" onclick="on()" id="peppers 75 6">Buy Now</button>
                ...
                <div class="grid_7 alpha">
                  <div class="wrapper"> <img src="images/page1-img4.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      ...
                      <button type="button" class="btn btn-success" onclick="on()" id="potatoes 40 7">Buy Now</button>
                ...
                <div class="grid_7">
                  <div class="wrapper"> <img src="images/page1-img1.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      ...
                      <button type="button" class="btn btn-success" onclick="on()" id="tomatoes 20 8">Buy Now</button>
