    ...
    <div class="inner">
      ...
      <nav>
        <ul class="sf-menu">
          ...
          <li class="current"><a href="fruits.php">Fruits</a></li>
            ...
            <article class="grid_22 suffix_1 prefix_1 alpha omega">
              ...
              <div class="wrapper indent-bot">
                <div class="grid_7 alpha">
                  <div class="wrapper"> <img src="pics/banana.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      <dt> <a href="#">Banana </a> </dt>
                      <h6>Rs.60/kg</h6>
                      <h6>Qty:</h6>
                      <input type="number" min="0" id="qty1"  value=0  style="width:65px;"><br>
                      <button type="button" class="btn btn-success" onclick="on()" id="banana 60 1">Buy Now</button>
                    </dl>
                  </div>
                </div>
                <div class="grid_7">
                  <div class="wrapper"> <img src="pics/apple.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      <dt> <a href="#">Apple</a> </dt>
                      <h6>Rs.100/kg</h6>
                      <h6>Qty:</h6>
                      <input type="number" min="0" id="qty2"  value=0  style="width:65px;"><br>
                      <button type="button" class="btn btn-success" onclick="on()" id="apple 100 2">Buy Now</button>
                    </dl>
                  </div>
                </div>
                <div class="grid_7 omega">
                  <div class="wrapper"> <img src="pics/grapes.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      <dt> <a href="#">Grapes</a> </dt>
                      <h6>Rs.80/kg</h6>
                      <h6>Qty:</h6>
                      <input type="number" min="0" id="qty3"  value=0  style="width:65px;">
                      <button type="button" class="btn btn-success" onclick="on()" id="grapes 100 3">Buy Now</button>
                    </dl>
                  </div>
                </div>
              </div>
              <div class="wrapper indent-bot">
                <div class="grid_7 alpha">
                  <div class="wrapper"> <img src="pics/kiwi.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      <dt> <a href="#">Kiwi</a> </dt>
                      <h6>Rs.50/kg</h6>
                      <h6>Qty:</h6>
                      <input type="number" min="0" id="qty4"  value=0  style="width:65px;"><br>
                      <button type="button" class="btn btn-success" onclick="on()" id="kiwi 50 4">Buy Now</button>

                    </dl>
                  </div>
                </div>
                <div class="grid_7">
                  <div class="wrapper"> <img src="pics/orange.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      <dt> <a href="#">Orange</a> </dt>
                      <h6>Rs.65/kg</h6>
                      <h6>Qty:</h6>
                      <input type="number" min="0" id="qty5"  value=0  style="width:65px;"><br>
                      <button type="button" class="btn btn-success" onclick="on()" id="orange 65 5">Buy Now</button>
                    </dl>
                  </div>
                </div>
                <div class="grid_7 omega">
                  <div class="wrapper"> <img src="pics/papaya.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      <dt> <a href="#">Papaya</a> </dt>
                      <h6>Rs.75/kg</h6>
                      <h6>Qty:</h6>
                      <input type="number" min="0" id="qty6"  value=0  style="width:65px;"><br>
                      <button type="button" class="btn btn-success" onclick="on()" id="papaya 75 6">Buy Now</button>
                    </dl>
                  </div>
                </div>
              </div>
              <div class="wrapper hr-border-1 indent-bot-2">
                <div class="grid_7 alpha">
                  <div class="wrapper"> <img src="pics/mango.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      <dt> <a href="#">Mango</a> </dt>
                      <h6>Rs.60/kg</h6>
                      <h6>Qty:</h6>
                      <input type="number" min="0" id="qty7"  value=0  style="width:65px;"><br>
                      <button type="button" class="btn btn-success" onclick="on()" id="mango 60 7">Buy Now</button>

                    </dl>
                  </div>
                </div>
                <div class="grid_7">
                  <div class="wrapper"> <img src="pics/watermelon.jpg" alt="" class="img-indent">
                    <dl class="extra-wrap def-list-1">
                      <dt> <a href="#">WaterMelon</a> </dt>
                      <h6>Rs.50/kg</h6>
                      <h6>Qty:</h6>
                      <input type="number" min="0" id="qty8"  value=0  style="width:65px;"><br>
                      <button type="button" class="btn btn-success" onclick="on()" id="watermelon 50 8">Buy Now</button>
